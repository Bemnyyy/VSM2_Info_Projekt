...
# Pfade
CSV_PATH = "/workspaces/VSM2_Info_Projekt/wegetagebuch_karlsruhe_geocoded.csv"
SHAPEFILE_PATH = "/workspaces/VSM2_Info_Projekt/Stadtteile_SHP/Stadtteile_Karlsruhe.shp"
